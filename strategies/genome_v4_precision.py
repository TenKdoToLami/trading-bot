"""
Genome V4 Precision Strategy — 3-State AI Architecture.
Transitions between CASH (Panic), SPY (Neutral), and 3xSPY (Bullish).
Evolves both the indicator weights AND the indicator lookback periods for each brain.
"""
...
class GenomeV4Precision(BaseStrategy):
    ...
    def on_data(self, date, price_data, prev_data):
        ...
        # Softmax over [Panic Margin, Bull Margin, Neutral(0)]
        # This shows the 'Relative Conviction' of each state
