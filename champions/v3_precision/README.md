...
| Goal | Command |
| :--- | :--- |
| **New Run** | `python tests/run_evolution_v3_precision.py --pop 500 --gen 100` |
| **Seed Run** | `python tests/run_evolution_v3_precision.py --pop 500 --gen 50 --vault champions/v3_precision/vault --mut 0.4` |
