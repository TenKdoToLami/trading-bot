...
def main():
    ...
    parser.add_argument('--vault', type=str, default='champions/v4_chameleon/vault')
    args = parser.parse_args()

    engine = EvolutionEngineV4(population_size=args.pop, generations=args.gen, mutation_rate=args.mut, seed_vault=args.vault)
    try: engine.run()
