...
def main():
    ...
    parser.add_argument('--vault', type=str, default='champions/v3_precision/vault')
    args = parser.parse_args()

    engine = EvolutionEngineV3(population_size=args.pop, generations=args.gen, mutation_rate=args.mut, seed_vault=args.vault)
    try: engine.run()
