...
def main():
    parser = argparse.ArgumentParser(description="Run Genetic Evolution for V6 Balancer")
    ...
    parser.add_argument("--min-cagr", type=float, default=20.0, help="Minimum CAGR threshold for vault saving")
