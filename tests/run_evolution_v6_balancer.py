...
def main():
    ...
    parser.add_argument('--vault', type=str, default='champions/v6_balancer/vault')
    args = parser.parse_args()

    engine = EvolutionEngineV6(population_size=args.pop, generations=args.gen, mutation_rate=args.mut, seed_vault=args.vault)
    try: engine.run()
