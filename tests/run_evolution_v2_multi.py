...
def main():
    ...
    parser.add_argument('--vault', type=str, default='champions/v2_multi/vault')
    args = parser.parse_args()

    engine = EvolutionEngineV2(population_size=args.pop, generations=args.gen, mutation_rate=args.mut, seed_vault=args.vault)
    try: engine.run()
