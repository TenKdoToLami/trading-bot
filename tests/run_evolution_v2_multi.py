...
def main():
    parser = argparse.ArgumentParser(description='Unified Evolution Runner: V2 Multi-Asset')
    ...
    parser.add_argument('--push-mid', action='store_true', help='Reward mid-tier residency (SPY/2xSPY)')
