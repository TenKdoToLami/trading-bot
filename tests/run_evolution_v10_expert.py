...
from src.tournament.evolution_v10_expert import EvolutionEngineV10Expert

def main():
    parser = argparse.ArgumentParser(description="Institutional Evolution: Model V10 Expert Ensemble")
    ...
    parser.add_argument("--vault", type=str, default="champions/v10_alpha/vault", help="Path to seed vault")
    parser.add_argument("--min-cagr", type=float, default=0.0, help="Minimum CAGR threshold for saving results")
    args = parser.parse_args()

    engine = EvolutionEngineV10Expert(
